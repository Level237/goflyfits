            ...
            <div class="row py-sm-5">
                ...
                <div class="col-xl-8 m-auto text-center">
                    ...
                    <h1 class="display-4 text-white mb-0">Let's Discover
                        <span class="position-relative z-index-9 d-block">GoFlyFits
                        ...
                        <form class="row g-3 justify-content-center align-items-center">
                            <div class="col-lg-5">
                                ...
                                <div class="form-input-dropdown position-relative">
                                    <input class="form-control form-control-lg me-1 ps-5" type="text" data-bs-toggle="dropdown" placeholder="What do you want?">
                                    <!-- dropdown button -->
                                    <ul class="dropdown-menu input-dropdown shadow rounded-0 rounded-bottom w-100">
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-building fa-fw text-primary me-2"></i>Workshop</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-egg-fried fa-fw text-primary me-2"></i>Afterwork</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-airplane fa-fw text-primary me-2"></i>Business</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-cup-straw fa-fw text-primary me-2"></i>Conference</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-tv fa-fw text-primary me-2"></i>Diplomatic Conference</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-car-front fa-fw text-primary me-2"></i>Entertainment</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-emoji-kiss fa-fw text-primary me-2"></i>Wedding</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-fire fa-fw text-primary me-2"></i>pubs</a></li>
                                    </ul>
                                    <!-- Icon -->
                                    ...
                                    <div class="icon-xl bg-mode rounded-circle mb-3">
                                        <figure>
                                            <svg width="44px" height="44px" viewbox="0 0 44 44" style="enable-background:new 0 0 44 44;" xml:space="preserve">
                                                <path class="fill-primary" d="M20.6,12.1c-6.3,0-11.4,5.1-11.4,11.4s5.1,11.4,11.4,11.4s11.4-5.1,11.4-11.4S26.8,12.1,20.6,12.1z M20.6,33.4 c-5.5,0-9.9-4.5-9.9-9.9s4.5-9.9,9.9-9.9s9.9,4.5,9.9,9.9S26.1,33.4,20.6,33.4z"></path>
                                                <path class="fill-primary" d="M20.6,19.2c-2.3,0-4.3,1.9-4.3,4.3c0,2.3,1.9,4.3,4.3,4.3s4.3-1.9,4.3-4.3S22.9,19.2,20.6,19.2z M20.6,26.3 c-1.6,0-2.8-1.3-2.8-2.8c0-1.6,1.3-2.8,2.8-2.8c1.6,0,2.8,1.3,2.8,2.8S22.1,26.3,20.6,26.3z"></path>
                                                <path class="fill-mode-inverse" d="M20.6,18.5c1.2,0,2.1-1,2.1-2.1s-1-2.1-2.1-2.1c-1.2,0-2.1,1-2.1,2.1S19.4,18.5,20.6,18.5z M20.6,15.6 c0.4,0,0.7,0.3,0.7,0.7S21,17,20.6,17c-0.4,0-0.7-0.3-0.7-0.7S20.2,15.6,20.6,15.6z"></path>
                                                <path class="fill-mode-inverse" d="M20.6,28.4c-1.2,0-2.1,1-2.1,2.1c0,1.2,1,2.1,2.1,2.1c1.2,0,2.1-1,2.1-2.1C22.7,29.3,21.8,28.4,20.6,28.4z M20.6,31.2 c-0.4,0-0.7-0.3-0.7-0.7s0.3-0.7,0.7-0.7c0.4,0,0.7,0.3,0.7,0.7S21,31.2,20.6,31.2z"></path>
                                                <path class="fill-mode-inverse" d="M13.5,21.3c-1.2,0-2.1,1-2.1,2.1c0,1.2,1,2.1,2.1,2.1s2.1-1,2.1-2.1C15.6,22.2,14.7,21.3,13.5,21.3z M13.5,24.1 c-0.4,0-0.7-0.3-0.7-0.7s0.3-0.7,0.7-0.7s0.7,0.3,0.7,0.7S13.9,24.1,13.5,24.1z"></path>
                                                <path class="fill-mode-inverse" d="M25.5,23.4c0,1.2,1,2.1,2.1,2.1c1.2,0,2.1-1,2.1-2.1c0-1.2-1-2.1-2.1-2.1C26.5,21.3,25.5,22.2,25.5,23.4z M27.7,22.7 c0.4,0,0.7,0.3,0.7,0.7s-0.3,0.7-0.7,0.7S27,23.8,27,23.4S27.3,22.7,27.7,22.7z"></path>
                                                <path class="fill-mode-inverse" d="M41.2,11.3l0.5-2c0.1-0.6,0.1-1.1-0.2-1.6l-1.6-2.7c-0.2-0.3-0.4-0.6-0.7-0.7l-2.7-1.6c-0.5-0.3-1.1-0.4-1.6-0.2l-2,0.5 C29.5,1,25.9,0,22,0c-0.4,0-0.7,0.3-0.7,0.7v2.1h-0.7C9.2,2.8,0,12.1,0,23.4S9.2,44,20.6,44s20.6-9.2,20.6-20.6v-0.7h2.1 c0.4,0,0.7-0.3,0.7-0.7C44,18.1,43,14.5,41.2,11.3z M35.1,3.7c0.2,0,0.4,0,0.5,0.1l2.7,1.6c0.1,0.1,0.2,0.1,0.2,0.2l1.6,2.7 c0.1,0.2,0.1,0.4,0.1,0.5l-0.2,0.7c-1.5-2.3-3.5-4.2-5.8-5.8L35.1,3.7z M20.6,42.6C10,42.6,1.4,34,1.4,23.4S10,4.3,20.6,4.3h0.7 v2.1c0,0.4,0.3,0.7,0.7,0.7c8.2,0,14.9,6.7,14.9,14.9c0,0.4,0.3,0.7,0.7,0.7h2.1v0.7C39.7,34,31.1,42.6,20.6,42.6z M40.5,21.3h-2.1 c-0.4-8.4-7.2-15.2-15.6-15.6V3.5V1.4c10.8,0.4,19.5,9.1,19.9,19.9H40.5z"></path>
                                                <path class="fill-primary" d="M6.4,23.4H5C5,32,12,39,20.6,39v-1.4C12.8,37.6,6.4,31.2,6.4,23.4z"></path>
                                            </svg>
                                        </figure>
                                    </div>
