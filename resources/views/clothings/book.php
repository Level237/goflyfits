                                    ...
                                    <div class="vstack gap-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-control-bg-light">
                                                            <input name="exp_month" type="text" class="form-control" maxlength="2">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-control-bg-light">
                                                            <input name="exp_year" type="text" class="form-control" maxlength="4">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-control-bg-light">
                                                            <input name="cvc" type="text" class="form-control" maxlength="3" placeholder="XXX">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card border">
                                            ...
                                            <div class="card-body text-center">
                                                <!-- Image -->
                                                <img src="{{ asset('assets/images/element/paypal.svg') }}" class="h-70px mb-3" alt="">
