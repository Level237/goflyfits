            ...
            <div class="card-body">
                ...
                <div class="bg-light rounded p-3 d-none d-lg-block">
                    <div class="row row-cols-7 g-4">
                        <div class="col"><h6 class="mb-0">Nom de la marque</h6></div>
              ...
              <div class="row row-cols-xl-7 align-items-lg-center border-bottom g-4 px-2 py-4">
                ...
                <div class="col">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!-- Info -->
                        <div class="ms-2">
                            <h6 class="mb-0 fw-light">{{ $brand->brand_title }}</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <small class="d-block d-lg-none">Payment:</small>
                        ...
                        <div style="font-size: 13px" class="badge bg-primary bg-opacity-10 p-2 text-success">{{ count($brand->clothings) }} look</div>
                </div>
