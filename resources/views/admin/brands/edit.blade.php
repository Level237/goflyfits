	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 mx-auto">
				<form class="vstack gap-4" method="POST" action="{{ route('admin.brands.update',$brand->id) }}">
                    @csrf
                    @method('PUT')
					<!-- Owner Detail START -->
							...
							<div class="row g-3">
								...
								<div class="col-12">
									...
									<div class="input-group">
										<input type="text" value={{ $brand->brand_title }} class="form-control" name="brand_title" placeholder="Entrez le nom de votre marque">
