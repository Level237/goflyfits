	...
	<div class="container" style="margin-top: 60px">
		<div class="row">
			<div class="col-12 mx-auto text-center">
				<h1 class="fs-2 mb-2">Edtion category</h1>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 mx-auto">
				<form class="vstack gap-4" method="POST" action="{{ route('admin.categories.update',$category->id) }}">
                    @csrf
                    @method('PUT')
					<!-- Owner Detail START -->
							...
							<div class="row g-3">
								...
								<div class="col-12">
									...
									<div class="input-group">
										<input type="text" value="{{ $category->category_title }}" class="form-control" name="category_title" placeholder="Entrez le nom de la categorie">
